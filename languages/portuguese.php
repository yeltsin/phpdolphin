...
$LNG['error'] = 'Erro';
$LNG['no_file'] = 'Você não selecionou nenhum arquivo para envio ou arquivo selecionado está vazio.';
$LNG['file_exceeded'] = 'O tamanho do arquivo solicitado não pode exceder <strong>%s</strong> MB.';
$LNG['file_format'] = 'O formato do arquivo é inválido. Os formatos aceito são: <strong>%s</strong>';
$LNG['image_removed'] = 'Imageem removida';
$LNG['bio_description'] = 'A biografia deve ter %s caracteres ou menos.';
$LNG['valid_email'] = 'Por favor, digite um e-mail válido.';
$LNG['valid_url'] = 'Por favor, digite uma URL válida.';
$LNG['valid_country'] = 'Por favor, digite um país válido.';
$LNG['password_too_short'] = 'A senha precisa conter ao menos 6 caracteres.';
$LNG['password_not_match'] = 'As senhas não combinam.';
$LNG['wrong_current_password'] = 'A senha atual que você digitou está incorreta.';
$LNG['username_not_found'] = 'Não conseguimos encontrar o usuário escolhido.';
$LNG['userkey_not_found'] = 'O nome do usuário ou chave de redefinição estão incorretos. Verifique se você digitou as credenciais corretas';
$LNG['password_reseted'] = 'Você redefiniu com sucesso sua senha, você poderá realizar o login agora com as novas credenciais.';
$LNG['email_sent'] = 'E-mail enviado';
$LNG['email_reset'] = 'Um e-mail contendo intruções para recuperar sua senha foi enviado. Por favor, aguarde até 24 horas para a mensagem chegar. Verifique também sua caixa de SPAM.';
$LNG['user_has_been_deleted'] = 'Usuário <strong>%s</strong> foi removido.';
$LNG['user_not_exist'] = 'O usuário selecionado não existe.';
$LNG['theme_changed'] = 'Tema modificado';
$LNG['notif_saved'] = 'Notificações alteradas';
$LNG['notif_success_saved'] = 'Notificações alteradas com sucesso';

// MAIL CONTENT
$LNG['welcome_mail'] = 'Bem-vindo ao %s';
$LNG['user_created'] = 'Obrigado por se juntar ao strong>%s</strong>.<br /><br />Your username: <strong>%s</strong><br />Your Password: <strong>%s</strong><br /><br />You can log-in at: <a href="%s" target="_blank">%s</a>';
...
// LIKES
$LNG['like'] = 'Curtir';
$LNG['dislike'] = 'Descurtir';
$LNG['liked'] = 'Curtido';
$LNG['liked_this'] = 'curtiu isto';
$LNG['view_all_likes'] = 'Veja todas as curtidas';
$LNG['people_who_like_this'] = 'Pessoas que curtiram isto';

// MISC
$LNG['sponsored'] = 'Patrocinado';
$LNG['censored'] = '<strong>censurado</strong>';
$LNG['new_like_notification'] = '<a href="%s" rel="loadpage">%s</a> curtiu sua <a href="%s" rel="loadpage">mensagem</a>';
$LNG['new_like_c_notification'] = '<a href="%s" rel="loadpage">%s</a> curtiu seu <a href="%s" rel="loadpage">comentário</a>';
$LNG['new_poke_notification'] = '<a href="%s" rel="loadpage">%s</a> te cutucou';
$LNG['new_comment_notification'] = '<a href="%s" rel="loadpage">%s</a> comentou em sua <a href="%s" rel="loadpage">mensagem</a>';
$LNG['new_shared_notification'] = '<a href="%s" rel="loadpage">%s</a> compartilhou sua <a href="%s" rel="loadpage">mensagem</a>';
$LNG['new_page_notification'] = '<a href="%s" rel="loadpage">%s</a> convidou você para curtir a <a href="%s" rel="loadpage">%s</a> página';
$LNG['new_group_notification'] = '<a href="%s" rel="loadpage">%s</a> convidou você para entra no <a href="%s" rel="loadpage">%s</a> grupo';
$LNG['new_friend_notification'] = '<a href="%s" rel="loadpage">%s</a> aceitou sua solicitação de amizade';
$LNG['new_chat_notification'] = '<a href="%s" rel="loadpage">%s</a> enviou uma <span class="desktop"><a onclick="%s">mensagem no chat</a></span><span class="mobile"><a href="%s" rel="loadpage">mensagem no chat</a></span>';
$LNG['new_birthday_notification'] = 'É aniversário de <a href="%s" rel="loadpage">%s</a>';
$LNG['years_old'] = '%s anos de idade';
$LNG['x_and_x_others'] = '<a href="%s" rel="loadpage">%s</a> e <a href="%s" rel="loadpage">%s outros</a>';
$LNG['new_like_fa'] = '<a href="%s" rel="loadpage">%s</a> curtiu uma <a href="%s" rel="loadpage">mensagem</a>';
$LNG['new_like_c_fa'] = '<a href="%s" rel="loadpage">%s</a> curtiu um <a href="%s" rel="loadpage">comentário</a>';
$LNG['new_comment_fa'] = '<a href="%s" rel="loadpage">%s</a> comentou em uma <a href="%s" rel="loadpage">mensagem</a>';
$LNG['new_message_fa'] = '<a href="%s" rel="loadpage">%s</a> publicou uma nova <a href="%s" rel="loadpage">mensagem</a>';
$LNG['change_password'] = 'Alterar Senha';
$LNG['enter_new_password'] = 'Digite sua nova senha';
$LNG['enter_reset_key'] = 'Digite sua chave de redefinição';
$LNG['enter_username'] = 'Digite seu nome de usuário';
$LNG['reset_key'] = 'Chave de Redefinição';
$LNG['new_password'] = 'Nova Senha';
$LNG['password_recovery'] = 'Recuperação de Senha';
$LNG['recover']	= 'Recuperar';
$LNG['recover_sub_username'] = 'Digite o e-mail ou usuário que você pretende recuperar a senha.';
...
// PROFILE
$LNG['profile_not_exist'] = 'Desculpe, mas este perfil não existe.';
$LNG['group_not_exist'] = 'Desculpe, mas este grupo não existe.';
$LNG['profile_semi_private'] = 'Desculpe, mas este perfil é privado. Apenas os amigos deste usuário podem ver o perfil.';
$LNG['profile_private'] = 'Desculpe, mas este perfil é completamente privado.';
$LNG['profile_suspended'] = 'Desculpe, este perfil não existe';
...
$LNG['title_feed'] = 'Feed de Publicações';
$LNG['title_post'] = 'Publicação';
$LNG['title_messages'] = 'Mensagem';
$LNG['title_settings'] = 'Configurações';
$LNG['title_search'] = 'Pesquisar';
$LNG['title_notifications'] = 'Notificações';
$LNG['title_page'] = 'Criar Página';
$LNG['title_group'] = 'Criar Grupo';
$LNG['title_admin']	= 'Adminastrador';
$LNG['edit'] = 'Editar';
$LNG['delete'] = 'Deletar';
$LNG['suspended'] = 'Suspender';
$LNG['ignore'] = 'Ignorar';
$LNG['view'] = 'Visualizar';
$LNG['timeline'] = 'Linha do Tempo';
$LNG['on'] = 'Ativo';
$LNG['off'] = 'Inativo';
$LNG['yes'] = 'Sim';
$LNG['no'] = 'Não';
$LNG['none'] = 'Nenhum';
$LNG['pages'] = 'Páginas';
$LNG['search_for_people'] = 'pesquise por pessoas, #hashtags, @paginas, !grupos';
$LNG['new_message'] = 'Nova mensagem';
$LNG['privacy_policy'] = 'Política de Privacidade';
$LNG['terms_of_use'] = 'Termos de Uso';
$LNG['about'] = 'Sobre';
$LNG['disclaimer'] = 'Disclaimer';
$LNG['contact'] = 'Contato';
$LNG['developers'] = 'Desenvolvedores';
$LNG['language'] = 'Idiomas';

// TIME
$LNG['just_now'] = 'a pouco tempo';
...
$LNG['month_7'] = 'Julho';
$LNG['month_8'] = 'Agosto';
$LNG['month_9'] = 'Setembro';
$LNG['month_10'] = 'Outubro';
$LNG['month_11'] = 'Novembro';
$LNG['month_12'] = 'Dezembro';
?>
